...
final class Source extends AbstractSource
{
    ...
    {
        if (array_key_exists($table, $this->data['columns'][$schema] ?? [])) {
            return;
        }
    ...
    protected function loadConstraintData(string $table, string $schema): void
    {
        ...
        if (array_key_exists($table, $this->data['constraints'][$schema] ?? [])) {
            return;
        }
    ...
    {
        if (array_key_exists($schema, $this->data['constraint_keys'] ?? [])) {
            return;
        }
    ...
    {
        if (array_key_exists($schema, $this->data['constraint_names'] ?? [])) {
            return;
        }
    ...
    {
        if (array_key_exists($schema, $this->data['table_names'] ?? [])) {
            return;
        }
    ...
    {
        if (array_key_exists($schema, $this->data['triggers'] ?? [])) {
            return;
        }
